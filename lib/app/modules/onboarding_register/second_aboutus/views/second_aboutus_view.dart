...
class SecondAboutusView extends GetView<SecondAboutusController> {
  const SecondAboutusView({super.key});
        ...
        appBar: AppBar(
          ...
          flexibleSpace: Padding(
            ...
            child: Container(
              ...
              child: Text('Services and Products',
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    ...
                    Get.toNamed(Routes.thirdAboutusOnboarding);
                  },
                  child: Text('Next',
                      style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                            color: const Color(0xFF1C4588),
