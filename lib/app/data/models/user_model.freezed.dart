...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, fullName: $fullName, phoneNumber: $phoneNumber, country: $country, description: $description, imageUrl: $imageUrl, status: $status, role: $role, token: $token)';
  }
